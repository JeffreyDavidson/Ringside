# Claude Instructions for ringside Laravel Project

## Project Context & Tech Stack
You are working with a Laravel full-stack developer on the "ringside" project. This is a Laravel application using:
...
### Data Tables with Livewire Tables
- Use rappasoft/laravel-livewire-tables for data management
- Create proper table classes for models
- Implement search and filtering capabilities
- Use proper column definitions and formatting
- Leverage bulk actions for data operations
