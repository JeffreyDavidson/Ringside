 ...
 * @method static \App\Builders\Events\EventBuilder<static>|Event newModelQuery()
 * @method static \App\Builders\Events\EventBuilder<static>|Event newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Event onlyTrashed()
 * @method static \App\Builders\Events\EventBuilder<static>|Event past()
 * @method static \App\Builders\Events\EventBuilder<static>|Event query()
 * @method static \App\Builders\Events\EventBuilder<static>|Event scheduled()
 * @method static \App\Builders\Events\EventBuilder<static>|Event unscheduled()
 ...
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager available()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager futureEmployed()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager injured()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager newModelQuery()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Manager onlyTrashed()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager query()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager released()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager retired()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager suspended()
 * @method static \App\Builders\Roster\ManagerBuilder<static>|Manager unemployed()
 ...
 * @property-read mixed $display_name
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee bookable()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee futureEmployed()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee injured()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee newModelQuery()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Referee onlyTrashed()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee query()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee released()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee retired()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee suspended()
 * @method static \App\Builders\Roster\RefereeBuilder<static>|Referee unemployed()
 ...
 * @property-read Collection<int, Wrestler> $previousWrestlers
 * @property int|null $user_id
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable activatedAfter(\Carbon\Carbon $date)
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable activatedBefore(\Carbon\Carbon $date)
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable active()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable activeDuring(\Carbon\Carbon $start, \Carbon\Carbon $end)
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable currentlyActive()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable currentlyInactive()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable deactivatedAfter(\Carbon\Carbon $date)
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable inactive()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable neverActivated()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable newModelQuery()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Stable onlyTrashed()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable query()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable retired()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable unactivated()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable withFutureActivation()
 * @method static \App\Builders\Roster\StableBuilder<static>|Stable withMultiplePeriods(int $minimumPeriods = 2)
 ...
 * @property int|null $user_id
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam bookable()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam futureEmployed()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam newModelQuery()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|TagTeam onlyTrashed()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam query()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam released()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam retired()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam suspended()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam unbookable()
 * @method static \App\Builders\Roster\TagTeamBuilder<static>|TagTeam unemployed()
 ...
 * @property-read mixed $display_name
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title activatedAfter(\Carbon\Carbon $date)
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title activatedBefore(\Carbon\Carbon $date)
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title active()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title activeDuring(\Carbon\Carbon $start, \Carbon\Carbon $end)
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title competable()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title currentlyActive()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title currentlyInactive()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title deactivatedAfter(\Carbon\Carbon $date)
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title inactive()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title neverActivated()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title newModelQuery()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Title onlyTrashed()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title query()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title retired()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title withFutureActivation()
 * @method static \App\Builders\Titles\TitleBuilder<static>|Title withMultiplePeriods(int $minimumPeriods = 2)
 ...
 * @method static \App\Builders\Users\UserBuilder<static>|User newModelQuery()
 * @method static \App\Builders\Users\UserBuilder<static>|User newQuery()
 * @method static \App\Builders\Users\UserBuilder<static>|User query()
 */
 ...
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler bookable()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler employed()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler futureEmployed()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler injured()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler newModelQuery()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Wrestler onlyTrashed()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler query()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler released()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler retired()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler suspended()
 * @method static \App\Builders\Roster\WrestlerBuilder<static>|Wrestler unemployed()
