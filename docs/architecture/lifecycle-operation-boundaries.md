...
4. Extract one shared lifecycle dimension from `StatusTransitionPipeline` at a time. (In progress: injury/healing, suspension/reinstatement, employment, and retirement/unretirement completed.)
