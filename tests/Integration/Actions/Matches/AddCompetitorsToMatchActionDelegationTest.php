...
test('it adds wrestler competitors to a match', function () {
    ...
    $addWrestlersToMatchAction->expects('handleWithinTransaction')->with(Argument::type(EventMatch::class), Argument::type(\Illuminate\Support\Collection::class), 0);
    $addWrestlersToMatchAction->expects('handleWithinTransaction')->with(Argument::type(EventMatch::class), Argument::type(\Illuminate\Support\Collection::class), 1);
...
test('it adds tag team competitors to a match', function () {
    ...
    $addTagTeamsToMatchAction->expects('handleWithinTransaction')->with(Argument::type(EventMatch::class), Argument::type(\Illuminate\Support\Collection::class), 0);
    $addTagTeamsToMatchAction->expects('handleWithinTransaction')->with(Argument::type(EventMatch::class), Argument::type(\Illuminate\Support\Collection::class), 1);
