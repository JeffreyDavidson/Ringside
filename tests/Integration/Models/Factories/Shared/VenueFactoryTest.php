...
namespace Tests\Integration\Models\Factories\Shared;
...
/**
 * Integration tests for VenueFactory data generation and state management.
 *
 ...
 * @see VenueFactory
 */
describe('VenueFactory Integration Tests', function () {
