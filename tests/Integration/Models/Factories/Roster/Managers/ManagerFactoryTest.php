...
namespace Tests\Integration\Models\Factories\Roster\Managers;
...
/**
 * Integration tests for ManagerFactory data generation and state management.
 *
 ...
 * @see ManagerFactory
 */
describe('ManagerFactory Integration Tests', function () {
