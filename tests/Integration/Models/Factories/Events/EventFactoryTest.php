...
namespace Tests\Integration\Models\Factories\Events;
...
/**
 * Integration tests for EventFactory data generation and state management.
 *
 ...
 * @see EventFactory
 */
describe('EventFactory Integration Tests', function () {
