...
use Tests\Integration\Models\Concerns\Support\EmploymentStateModel;

describe('IsEmployable Trait Integration Tests', function () {
    describe('employment relationships', function () {
        ...
        test('employments relationship uses the correct related model', function () {
            ...
            expect($relation)->toBeInstanceOf(MorphMany::class)
                ->and($relation->getRelated())->toBeInstanceOf(Employment::class);
        });
    ...
    describe('employment status checks', function () {
        ...
        test('can check if model has future employment through its relationship', function () {
            ...
            expect($modelWith->futureEmployment()->exists())->toBeTrue()
                ->and($modelWithout->futureEmployment()->exists())->toBeFalse();
        });
        ...
        test('can check if model has employment history through its relationship', function () {
            ...
            expect($modelWith->employments()->exists())->toBeTrue()
                ->and($modelWithout->employments()->exists())->toBeFalse();
        });
    });
