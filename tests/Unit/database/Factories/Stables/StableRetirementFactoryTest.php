...
/**
 * Unit tests for StableRetirementFactory data generation and state management.
 *
 * UNIT TEST SCOPE:
 ...
 *
 * These tests verify that the StableRetirementFactory generates consistent,
...
describe('StableRetirementFactory Unit Tests', function () {
    describe('default attribute generation', function () {
        test('creates retirement with correct default attributes', function () {
            // Arrange & Act
            $retirement = StableRetirement::factory()->make();

            // Assert
            expect($retirement->stable_id)->toBeInt();
    ...
    describe('factory customization', function () {
        test('accepts custom stable association', function () {
            ...
            // Act
            $retirement = StableRetirement::factory()->make(['stable_id' => $stable->id]);
    ...
    describe('data consistency', function () {
        test('database creation works correctly', function () {
            // Arrange & Act
            $retirement = StableRetirement::factory()->create();
