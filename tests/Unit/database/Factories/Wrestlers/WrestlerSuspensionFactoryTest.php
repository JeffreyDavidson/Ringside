...
/**
 * Unit tests for WrestlerSuspensionFactory data generation and state management.
 *
 * UNIT TEST SCOPE:
 ...
 *
 * These tests verify that the WrestlerSuspensionFactory generates consistent,
...
describe('WrestlerSuspensionFactory Unit Tests', function () {
    describe('default attribute generation', function () {
        test('creates suspension with correct default attributes', function () {
            // Arrange & Act
            $suspension = WrestlerSuspension::factory()->make();

            // Assert
            expect($suspension->wrestler_id)->toBeInt();
    ...
    describe('factory customization', function () {
        test('accepts custom wrestler association', function () {
            ...
            // Act
            $suspension = WrestlerSuspension::factory()->make(['wrestler_id' => $wrestler->id]);
    ...
    describe('data consistency', function () {
        test('database creation works correctly', function () {
            // Arrange & Act
            $suspension = WrestlerSuspension::factory()->create();
