            ...
            <x-card>
                <x-card.body>
                    ...
                    <x-card.detail-container id="kt_event_view_details">
                        ...
                        <x-card.detail-row property="Preview" value="{{ nl2br($event->preview) ?? 'No preview added'}}" />
                    ...
                    @unless ($event->venue)
                        <x-notice class="mt-4" title="This event needs your attention!" description="This event does not have a venue assigned and needs to be chosen." />
                    @endif
                </x-card.body>
            </x-card>
        </x-details-card>
