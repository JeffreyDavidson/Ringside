...
<div @class([
    ...
    <div @if ($this->isFilterLayoutPopover()) x-data="{ filterPopoverOpen: false }"
        ...
        <button type="button" @class([
            ...
            'inline-flex items-center cursor-pointer leading-4 rounded-md border border-solid border-transparent outline-none h-8 ps-3 pe-3 font-medium text-xs gap-[.275rem] text-primary bg-primary-light border-primary-clarity' =>
                $this->isTailwind,
        ])
