<div class="flex" x-data="{ open: false }">
    <div class="flex flex-col m-0 p-0">
        <button x-ref="button" @click="open = ! open"
            ...
            <i class="ki-dots-vertical text-lg"></i>
        </button>
            ...
            <ul>
                <li class="flex flex-col m-0 p-0">
                    <a class="group flex items-center grow cursor-pointer m-0 p-2.5 ms-2.5 me-2.5 rounded-md hover:bg-gray-100"
                        ...
                        <span class="flex items-center shrink-0 me-2.5">
                            <i class="ki-search-list text-gray-500 text-lg group-hover:text-primary"></i>
                        </span>
                ...
                <li class="flex flex-col m-0 p-0">
                    <button
                        ...
                        <span class="flex items-center shrink-0 me-2.5">
                            <i class="ki-pencil text-gray-500 text-lg group-hover:text-primary"></i>
                        </span>
                ...
                <li class="flex flex-col m-0 p-0">
                    <a class="group flex items-center grow cursor-pointer m-0 p-2.5 ms-2.5 me-2.5 rounded-md hover:bg-gray-100"
                        ...
                        <span class="flex items-center shrink-0 me-2.5">
                            <i class="ki-trash text-gray-500 text-lg group-hover:text-primary"></i>
                        </span>
