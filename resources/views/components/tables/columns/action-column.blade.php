            ...
            <ul>
                <li class="flex flex-col m-0 p-0">
                    <a class="group flex items-center grow cursor-pointer m-0 p-2.5 ms-2.5 me-2.5 rounded-md hover:bg-gray-100"
                        ...
                        <span class="flex items-center shrink-0 me-2.5">
                            <x-heroicon-s-magnifying-glass class="text-gray-500 text-lg group-hover:text-primary" />
                        </span>
                ...
                <li class="flex flex-col m-0 p-0">
                    <button
                        ...
                        <span class="flex items-center shrink-0 me-2.5">
                            <x-heroicon-s-pencil class="text-gray-500 text-lg group-hover:text-primary" />
                        </span>
                ...
                <li class="flex flex-col m-0 p-0">
                    <a class="group flex items-center grow cursor-pointer m-0 p-2.5 ms-2.5 me-2.5 rounded-md hover:bg-gray-100"
                        ...
                        <span class="flex items-center shrink-0 me-2.5">
                            <x-heroicon-s-trash class="text-gray-500 text-lg group-hover:text-primary" />
                        </span>
