        ...
        >
            ...
            <div class="flex items-center gap-2 px-5 py-1.5">
                ...
                <div class="flex flex-col gap-1.5">
                    <span class="text-sm leading-none font-semibold text-gray-800"> {{ $user->full_name }} </span>
                    <span class="text-xs leading-none font-medium text-gray-600"> {{ $user->email }} </span>
                </div>
            </div>
