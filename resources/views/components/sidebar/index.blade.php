    ...
    >
        <div class="border-ringside-line relative flex h-[var(--header-height)] min-h-[var(--header-height)] shrink-0 items-center border-b px-6 group-data-[collapsed=true]:px-4">
            ...
            <button
                ...
                class="border-ringside-line bg-ringside-surface-header text-ringside-muted hover:bg-ringside-surface-hover hover:text-ringside-ink focus-visible:outline-ringside-ink absolute end-0 top-1/2 hidden size-10 translate-x-1/2 -translate-y-1/2 items-center justify-center border transition-transform duration-300 ease-out focus-visible:outline-2 focus-visible:outline-offset-4 lg:inline-flex"
            >
