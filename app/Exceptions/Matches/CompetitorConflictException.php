...
class CompetitorConflictException extends BaseBusinessException
{
     ...
     */
    public static function doubleBooked(Model $competitor, Model $existingMatch, Model $newMatch): self
    {
     ...
     */
    public static function competitorInjured(Model $competitor, ?Carbon $injuryDate = null): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function competitorSuspended(Model $competitor, ?string $reason = null): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function competitorRetired(Model $competitor, ?Carbon $retirementDate = null): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function competitorUnemployed(Model $competitor): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function contractualRestriction(Model $competitor, string $restriction): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function doesNotMeetRequirements(Model $competitor, string $requirement): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function insufficientTagTeamMembers(Model $tagTeam, int $activeMembers, int $required): self
    {
     ...
     */
    public static function insufficientStableMembers(Model $stable, int $activeMembers, int $required): self
    {
     ...
     */
    public static function ageRestriction(Model $competitor, int $age, int $minimumAge): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function experienceRequirement(Model $competitor, string $currentLevel, string $requiredLevel): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function notEligibleForTitle(Model $competitor, Model $title, string $reason): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function currentChampion(Model $competitor, Model $title): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
        $titleName = $title->getAttribute('name') ?? "ID: {$title->getAttribute('id')}";
     ...
     */
    public static function travelRestriction(Model $competitor, Model $venue, string $restriction): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function medicalClearanceRequired(Model $competitor, string $requirement): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
     ...
     */
    public static function outsideBookingWindow(Model $competitor, Carbon $eventDate, int $requiredDaysNotice): self
    {
        $competitorName = $competitor->getAttribute('name') ?? "ID: {$competitor->getAttribute('id')}";
        $competitorType = class_basename($competitor);
