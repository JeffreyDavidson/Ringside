 ...
 * @method static \Database\Factories\Roster\Stables\StableFactory factory($count = null, $state = [])
...
class Stable extends Model implements HasActivityPeriodsContract, Retirable, SoftDeletable
{
    ...
    {
        return Attribute::get(fn (): StableStatus => StableStatusResolver::resolveFor($this));
    }
}
