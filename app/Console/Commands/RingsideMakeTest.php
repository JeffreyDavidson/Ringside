...
class RingsideMakeTest extends Command
{
    ...
    protected function handleInteractiveModelTest(Filesystem $filesystem): int
    {
        ...
        $modelName = text(
            ...
            placeholder: 'e.g., Product, User, EventMatch',
            required: true,
    ...
    protected function resolveModelClass(string $modelName, ?string $directory = null): string
    {
        ...
        $patterns = [
            ...
            "App\\Models\\Roster\\Wrestlers\\{$modelName}",
            "App\\Models\\Roster\\Managers\\{$modelName}",
            "App\\Models\\Roster\\Referees\\{$modelName}",
            "App\\Models\\Roster\\TagTeams\\{$modelName}",
            "App\\Models\\Titles\\{$modelName}",
            "App\\Models\\Events\\{$modelName}",
            "App\\Models\\Roster\\Stables\\{$modelName}",
