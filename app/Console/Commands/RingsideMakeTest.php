...
class RingsideMakeTest extends Command
{
     ...
     * @var string
     */
    protected $signature = 'ringside:make:test {name? : The name of the test (optional)} {--unit : Create a unit test} {--feature : Create a feature test} {--model= : Generate a model test for the specified model} {--directory= : Specify model directory (e.g., Users for Users/User)} {--action= : Generate an action test for the specified action} {--repository= : Generate a repository test for the specified repository}';
